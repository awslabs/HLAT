...
class LlamaRMSNorm(LlamaRMSNormHF):
    def __init__(self, hidden_size, eps=1e-6, sequence_parallel_enabled=False, amp_enabled=False):
        """
...
class CoreAttention(nn.Module):
    def __init__(self, amp_enabled=False):
        super().__init__()
        # Haozheng amp
        self.amp_enabled = amp_enabled
...
class LlamaAttention(LlamaAttentionHF):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        self.core_attn = CoreAttention(self.config.amp_enabled)
...
class LlamaDecoderLayer(LlamaDecoderLayerHF):
    def __init__(self, config: LlamaConfig):
        ...
        self.input_layernorm = LlamaRMSNorm(config.hidden_size, eps=config.rms_norm_eps, sequence_parallel_enabled=config.sequence_parallel_enabled, amp_enabled=config.amp_enabled)
        self.post_attention_layernorm = LlamaRMSNorm(config.hidden_size, eps=config.rms_norm_eps, sequence_parallel_enabled=config.sequence_parallel_enabled, amp_enabled=config.amp_enabled)
...
class LlamaModel(LlamaModelHF):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        self.norm = LlamaRMSNorm(config.hidden_size, eps=config.rms_norm_eps, sequence_parallel_enabled=config.sequence_parallel_enabled, amp_enabled=config.amp_enabled)
